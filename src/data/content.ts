...
export const content: Record<'tr' | 'en', LanguageContent> = {
  tr: {
    ...
    about: {
      ...
      interests: {
        title: 'İlgi Alanları',
        items: ['Endüstri Mühendisliği', 'Yapay Zeka & Makine Öğrenimi', 'Optimizasyon Algoritmaları', 'Agent tabanlı Simülasyon', 'Proje & Ürün Yönetimi', 'Girişimcilik']
      },
      languages: {
        title: 'Diller',
        turkish: 'Türkçe',
    ...
    skills: {
      ...
      expertise: {
        title: 'Uzmanlık',
        items: ['Makine Öğrenimi', 'Optimizasyon Algoritmaları', 'Yöneylem Araştırması', 'Proje Yönetimi', 'Ürün Yönetimi', 'Mobil ve Web Uygulama Geliştirme', 'Simülasyon', 'Yapay Zeka', 'E-Ticaret ve Reklamcılık']
      }
    },
    certifications: {
  ...
  en: {
    ...
    about: {
      ...
      interests: {
        title: 'Interests',
        items: ['Industrial Engineering', 'AI & Machine Learning', 'Optimization Algorithms', 'Agent-based Simulation', 'Project & Product Management', 'Entrepreneurship']
      },
      languages: {
        title: 'Languages',
        turkish: 'Turkish',
    ...
    skills: {
      ...
      expertise: {
        title: 'Expertise',
        items: ['Machine Learning', 'Optimization Algorithms', 'Operations Research', 'Project Management', 'Product Management', 'Mobile & Web Development', 'Simulation', 'Artificial Intelligence', 'E-Commerce & Advertising']
      }
    },
    certifications: {
